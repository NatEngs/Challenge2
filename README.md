# Challenge2
Utilized activity resources from class and MDN resources to complete assignment.

Opted for a clean and condensed presentation for the portfolio.  Tried to keep it to one page on load.  I still have to complete the jump link, however, I am happy how it appears when shrinking the screen size down.
